...
public class JComponentGameStatus
	...
	private JComponentShipGameStatus oListaStatkowGracz;
	 ...
	 */
	public JComponentGameStatus(GameStatus oStatusGry)
		{
		super();
		...
		try
			{
			oListaStatkowGracz = new JComponentShipGameStatus(oShipsGracz);
			oListaStatkowKomputer = new JComponentShipGameStatus(oShipsKomputer);
